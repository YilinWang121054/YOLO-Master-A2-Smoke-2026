...
9月13日新增[固定checkpoint的候选质量诊断](results/candidate-quality-20260913/)：同一模型与16张图像下，adaptive增加的正样本数量没有转化为同比例的监督权重增量。原始候选记录、采集等价测试和独立汇总核验均保留；这是离线诊断，不是训练历史补录或P1达标证据，配套图尚待制作。
