...
本组使用第120轮last.pt和CPU FP32预测。总体列仍来自源码对齐的Python DET；额外启动MATLAB时返回5201，尚未产生本组MATLAB指标，此前P0的成功对齐仍有效。[完成说明](P1第二轮fixed完成-20260915.md)记录配置、断点恢复、哈希及本次失败日志，[逐轮曲线和源数据](../../results/closure-evaluation/p1-v2-fixed-s20260825-stats120/figures/)保留全部观测。单组fixed完成没有改变P1尚未达标的结论。
