...
版本：2026-09-13 晚，补齐 P0 官方 MATLAB 实测对齐，保留三模式参考结果与候选诊断。原始基线的120轮训练、逐轮正样本记录和完整验证已经完成；P0材料待导师验收。现有结果不支持P1提升目标，第二轮统一协议补跑已启动 fixed 对照，P2尚未完成。
...
P0的训练、逐轮统计、分档结果、原始日志和官方 MATLAB 实测对齐已收齐，待导师验收。P1尚缺同协议三seed主表、对应训练期统计与Mosaic交互，现有参考结果也未达到提升目标。9月13日新增的[真实增强 batch CUDA 检查](../../results/p1-v2-amp-audit-20260913/README.md)发现：三模式的 FP32/AMP loss 和梯度均有限，但分配并不完全一致，梯度相对 L2 差异约9%～15%。第二轮保持FP32，已启动带逐轮统计的fixed 120e；adaptive筛选和剩余对照见[补齐方案](P1第二轮补齐方案-20260913.md)。P2扫描和扩展仍未完成；#253单列为工程贡献，不以代码合并或smoke通过替代量化要求。
