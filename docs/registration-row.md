...
- seed 20260826 三组 120 epoch 链已于 `2026-09-07 20:27:14 UTC`（本地 `2026-09-08 04:27:14 +08:00`）启动，当前 fixed STAL 运行中，随后串行 adaptive STAL、pure TAL；启动清单见 [`docs/p1-seed3-launch.md`](p1-seed3-launch.md)。
